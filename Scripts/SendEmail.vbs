' 1) WScript.Arguments(0) - ïóòü ê ini ôàéëó
'    WScript.Arguments(0) - ñïèñîê ðàññûëêè, òîãäà áàçîâûé ini áðàòü \\IRON2\secur$\deal68\Util\MailTo\Default.ini
' 2) WScript.Arguments(1) - ïóòü ê àòòà÷ó
' 3) WScript.Arguments(2) - ïåðåèìåíîâûâàòü ôàéë 
'    1 - YYYY-MM-DD
'    2 - HH-MI-SS
...
' %ArchiveFolder% - U:\DiasoftReportArchive\SMTH (èç ini ôàéëà)
                    ...
                    If intEqualPos > 0 Then
                        ...
                        If LCase( strLeftString ) = LCase( strKey ) Then
                            ...
                            If ReadIni = "" Then
                               ReadIni = " "
                            End If
'Çàìåíà óñëîâíûõ íà áåçóñëîâíûå
